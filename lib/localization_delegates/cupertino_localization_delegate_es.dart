...
class CupertinoLocalizationEsDelegate
    extends LocalizationsDelegate<CupertinoLocalizations> {
  @override
  bool isSupported(Locale locale) {
    return locale.countryCode == "ES" && locale.languageCode == "es";
  }

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return EsMaterialLocalization();
  }
...
class EsMaterialLocalization extends CupertinoLocalizations {
  @override
